...
class DecimalCollectionTest {
    ...
    @Test
    void testMenor() {
        assertEquals(-1.0, this.decimalCollection.menor());
    }

    @Test
    void testMenorArithmeticExceptionIfEmpty() {
        assertThrows(ArithmeticException.class, () -> new DecimalCollection().menor());
    }
